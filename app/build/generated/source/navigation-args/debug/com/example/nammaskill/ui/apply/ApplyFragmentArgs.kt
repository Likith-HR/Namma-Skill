...
public data class ApplyFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): ApplyFragmentArgs {
      bundle.setClassLoader(ApplyFragmentArgs::class.java.classLoader)
      ...
      return ApplyFragmentArgs(__courseId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): ApplyFragmentArgs {
      val __courseId : String?
